...
public class EditNotesActivity extends ListActivity implements OnClickListener {
    ...
    public static final String EXTRA_NOTE_Author = "noteAuthor";
    public static final String EXTRA_NOTE_CONTENT = "noteContent";
    private EditText etName,etAuthor, etContent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // String s=sharedPreferences.getString("author","xu");
        SharedPreferences.Editor editor =getSharedPreferences("data",MODE_PRIVATE).edit();
        editor.putString("author","xu");
        SharedPreferences pref =getSharedPreferences("data",MODE_PRIVATE);
        String s=pref.getString("author"," xu ");
        //editor.apply();
...
//修改某条日志
        ...
        if (noteId > -1) {
            ...
            etAuthor.setText(getIntent().getStringExtra(EXTRA_NOTE_Author));
    ...
    public int saveNote() {
        ...
        cv.put(NotesDB.COLUWM_NAME_NOTE_NAME, etName.getText().toString()
                .trim());
        cv.put(NotesDB.COLUWM_NAME_NOTE_AUTHOR, etAuthor.getText().toString()
                .trim());
